...
class Solution {
    ...
    minDeletions(s) {
        ...
        return m-this.lcs(s1,s2,m,n,cache)
...
// this also work for min no of insertions
// as it meant same if you observe carefully
// in one case you have to delete the char and return that count
// in another you have to insert the same count of char as deleted 
