...
// Difficulty: MediumAccuracy: 73.14%Submissions: 9K+Points: 4
...
function check(q) {
  ...
  //insert half start element to stack
  for (let i = 0; i <= mid; i++) {
    stack.push(q.shift());
  }
  // add starting element to front of queue one from queue rear & one from stack top
...
console.log(check([1, 4, 8, 7, 5, 6, 3, 2]));
