// Circular tour
// Difficulty: MediumAccuracy: 34.79%Submissions: 176K+Points: 4
...
{
    //your code here
let cur = 0 , front = 0 , rear= 0, rem = 0
let deficiit = 0
while(true)
{
cur =rem + p[rear].petrol
//1+5 =6
rem = cur - p[rear].distance
//4-3 =1 6-8 -2
if(rem<0){
front = rear+1
//2
